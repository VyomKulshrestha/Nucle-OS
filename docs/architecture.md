...
Beyond durable persistence, concurrency safety, encryption at rest, and proactive integrity scanning (above), the following remain deliberate non-goals for the current design:
