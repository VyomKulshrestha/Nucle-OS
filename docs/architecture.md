...
Beyond durable persistence, concurrency safety, encryption at rest, proactive integrity scanning, and per-tenant pool isolation (above), the following remain deliberate non-goals for the current design:
